...
private struct Capabilities: Encodable {
    ...
    var platform = "macos"
    var commands = ["capabilities", "inspect-media", "validate-project", "render-project"]
...
enum CineleafAutomationCLI {
    ...
    private static func message(for error: Error) -> String {
        if case CLIError.invalidArguments = error {
            return "Usage: capabilities | inspect-media <path> | validate-project <project.cineleaf> | render-project <project.cineleaf> <output> <p720|p1080|p1440|p2160> <h264|hevc> <compact|balanced|high>"
        }
